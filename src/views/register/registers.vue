  ...
  <div class="register_bg">
    ...
    <van-popup v-model="registerTrueFalseBy" round class="register">
      <div class="register_box">
        ...
        <ul class="list">
          <li class="item">
            ...
            <div class="input">
              ...
              <div class="right">
                <van-field class='ra' v-model="rphone" clearable placeholder="请输入手机号"/>
              </div>
            </div>
          </li>
               <li class="item">
            ...
            <div class="input">
              ...
              <div class="right">
                <van-field class='ra' v-model="password" clearable placeholder="请输入密码"/>
              </div>
            </div>
          </li>
          <li class="item">
            ...
            <div class="input">
              ...
              <div class="right">
                <van-field class='ra' v-model="sms" center clearable placeholder="请输入短信验证码">
                  <template #button>
        ...
        <div class="btn" @click="_authPhone">注册</div>
